...
output_data=read.table("~/Desktop/Rfiles-SEQ-AB/stageIII-ML/RDC-TDA-ESTF-SVM/RDC-TDA-RIPS20-ESTF-SVM/RDC-TDA-RIPS20-40bins-ESTF-LIBLINEAR/Liblinear-s5-ESTF-RIPS/output.txt",header=F)
...
CM
CM <- confusionMatrix(class_pred,class_true)
